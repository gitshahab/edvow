      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <p className="font-sans text-slate-500 text-sm leading-relaxed max-w-xs">
              My vow: To empower your ambition until you succeed. Providing
              precision counseling for the next generation of global leaders,
              alongside robust IT solutions engineered for startups and scaling
              enterprises.
            </p>
          </div>
          ...
          {/* quick links */}
          <div>
            <h4 className="font-heading text-xs uppercase tracking-[0.2em] font-bold text-edvow-blue mb-6">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-2">
                {/* instagram Icon */}
                <a
                  href="https://instagram.com/edvow.official"
                  className="text-slate-400 hover:text-edvow-blue transition-colors"
                >
                  <svg
                    width="20"
                    height="20"
                ...
                {/* linkedIn Icon */}
                <a
                  href="https://www.linkedin.com/company/edvow"
                  className="text-slate-400 hover:text-edvow-blue transition-colors"
                >
                  <svg
                    width="20"
        ...
        <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8 font-sans text-[10px] uppercase tracking-widest text-slate-400">
            <Link href="/privacypolicy" className="hover:text-edvow-blue">
