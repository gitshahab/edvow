...
const faqs = [
  {
    ...
    a: "We partner with leading financial institutions to spread your counseling fees over 6-12 months at 0% interest, ensuring your focus remains entirely on your studies."
  },
  {
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div>
          <h2 className="font-heading text-4xl md:text-5xl font-bold text-edvow-blue tracking-tighter mb-6">
            Everything you <span className="text-edvow-orange">need to know.</span>
          </h2>
