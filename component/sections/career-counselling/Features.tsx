...
const features = [
  {
    ...
    answer:
      "To travel and work globally, communication is key. We bridge the gap to your dream master's degree.",
    img: "/faq1.webp",
  },
  {
    question: "Financial Stress?",
    answer:
      "Focus on your future with our No-Cost EMI options. Your education, your terms.",
    img: "/faq2.webp",
  },
  {
    question: "Hardware Hurdles?",
    answer:
      "Get a complimentary tablet with your enrollment. We provide the tools; you provide the ambition.",
    img: "/faq3.webp",
  },
];
