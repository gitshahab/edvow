  ...
  return (
    <section className="mx-6 md:mx-12 lg:mx-20 mb-24 bg-edvow-blue p-12 md:p-20 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8">
        ...
        <a href="mailto:hello@edvow.com"  className="bg-white text-edvow-blue px-2 md:px-12 py-5 font-heading font-bold uppercase md:tracking-[0.2em] text-xs md:text-sm hover:bg-edvow-orange hover:text-white transition-all">
